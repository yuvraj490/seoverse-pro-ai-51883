...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary to-background p-4 relative overflow-hidden">
      ...
      <Card className="glass-effect border-primary/30 p-8 shadow-[0_0_60px_rgba(168,85,247,0.3)] hover:shadow-[0_0_80px_rgba(168,85,247,0.4)] transition-all duration-300 relative">
        ...
        {showPaymentDialog ? (
          <div className="space-y-6 max-h-[500px] overflow-y-auto pr-2 animate-fade-in">
            <form onSubmit={handleUpgrade} className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 bg-gradient-to-r from-primary to-accent hover:opacity-90 h-12 text-base font-semibold shadow-[0_0_30px_rgba(168,85,247,0.3)]"
                >
                  {submitting ? (
